...
姓名、学校、岗位、奖项和历史成绩来自用户提供的简历与本次确认。教育年份采用用户确认的本科 2019–2023、硕士 2025 年至今。2026-09-08 用户确认西北工业大学硕士专业为软件工程，新增华为杯中国研究生数学建模竞赛全国三等奖（硕士一年级）和京东编程与算法设计大赛全国百强。华为杯不推测具体年份与届次，京东百强暂不标年份或教育阶段。原有四项本科奖项均来自简历；按用户要求不展示蓝桥杯省一、国三。Codeforces 1951 / Candidate Master 继续明确标为历史成绩。
